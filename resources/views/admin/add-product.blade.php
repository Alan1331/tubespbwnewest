                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <input type="file" name="gambar" class="form-control" value="{{ number_format($barang->gambar) }}" required autocomplete="gambar">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Nama Barang</td>
                                                <td>:</td>
                                                <td>
                                                    <input type="text" name="nama_barang" class="form-control" value="{{ number_format($barang->nama_barang) }}" required autocomplete="nama_barang">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Harga</td>
